 ...
 * =============================================================================
 * Número Oficial de Soporte: +503 7574 344 (5037574344)
...
export const BOLTECH_SUPPORT_PHONE = '5037574344';
export const BOLTECH_SUPPORT_PHONE_DISPLAY = '+503 7574 344';
export const BOLTECH_SUPPORT_WA_URL = 'https://wa.me/5037574344';
...
export async function handleSupportWithGemini({ message, senderPhone = null, history = [] }) {
  ...
  const systemPrompt = `Eres "Soporte BolTech Group", el asistente de atención al cliente e ingeniería de soporte fiduciario de BolTech Group y Destraba AI.
...
4. Directrices de Atención:
   ...
   - Si el usuario requiere contratar servicios, agendar reunión o hablar con un humano, indícale con cortesía que puede escribir directamente al WhatsApp oficial ${BOLTECH_SUPPORT_PHONE_DISPLAY} o al correo soporte@destraba.ai para ser atendido por Ricardo Bolaños.
