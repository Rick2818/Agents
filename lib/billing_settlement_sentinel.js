...
export const BOLTECH_PRICING_CATALOG = Object.freeze({
  'flash': {
    id: 'flash',
    name: 'Parche de Ciberseguridad Flash',
    amountUSD: 19,
    type: 'one_time',
    description: 'Parche técnico de remediación inmediata listo para producción (Nginx/Cloudflare/Apache/Vercel) y auditoría perimetral.'
  },
  'pro': {
    id: 'pro',
