...
// --- PILAR 4: CLAVE VOLÁTIL EN MEMORIA RAM AL ARRANCAR (SI FALTA SESSION_SECRET) ---
const VOLATILE_MEMORY_SECRET = process.env.SESSION_SECRET || crypto.randomBytes(32).toString('hex');
