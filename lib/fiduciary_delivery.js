...
export async function sendCustomerDeliveryEmail({ toEmail, domain = 'tu-empresa.com', planId = 'flash_audit_19', invoiceId = '', amountUsd = '19.00' }) {
  ...
  try {
    ...
    const textContent = `Destraba AI • Entrega Fiduciaria\nPaquete de Blindaje y Licencia Verificada para ${cleanDomain}\nConfirmamos la liquidación de tu licencia por $${amountUsd} USD (Ref: ${invoiceId}). Adjunto encontrarás blindaje_${cleanDomain}.zip.\nSoporte: ricardo.destrabaai@gmail.com`;
