...
**Auditor Fiduciario:** Boltech Group Defensive Engine 2.5  
...
# PARCHE DE BLINDAJE BANCARIO NGINX — Boltech Group
...
# PARCHE DE BLINDAJE APACHE (.htaccess) — Boltech Group
# Aplicable para: ${cleanDomain}
# =============================================================================
...
Boltech Group / UNBLOCK AI — INSTRUCCIONES DE DESPLIEGUE EN 60 SEGUNDOS
=============================================================================
...
3. SOPORTE DIRECTO 24/7:
   - Correo Oficial: soporte@boltech.ai
...
export async function sendCustomerDeliveryEmail({ toEmail, domain = 'tu-empresa.com', planId = 'flash_audit_19', invoiceId = '', amountUsd = '19.00' }) {
  ...
  try {
    ...
    const activationUrl = `https://boltech-group.vercel.app/?licencia=${encodeURIComponent(invoiceId || 'LIC-FIDUCIARY-2026')}&plan=${encodeURIComponent(planId || 'standard_agent')}&email=${encodeURIComponent(toEmail)}`;
    ...
    const htmlContent = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 620px; margin: 0 auto; padding: 28px; color: #1e293b; background-color: #f8fafc; border-radius: 16px; border: 1px solid #e2e8f0;">
        <div style="text-align: center; margin-bottom: 24px;">
          ...
          <h1 style="color: #0f172a; margin: 0 0 6px 0; font-size: 22px; font-weight: 800;">Boltech Group • Despacho Fiduciario</h1>
        ...
        <div style="background-color: #ffffff; padding: 24px; border-radius: 12px; border: 1px solid #cbd5e1; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
          ...
          <div style="background-color: #f1f5f9; padding: 16px; border-radius: 8px; font-size: 13px; color: #334155; margin-bottom: 16px;">
            ...
            <ol style="margin: 0; padding-left: 20px; line-height: 1.6;">
              <li><strong>Activación:</strong> Haz clic en el botón superior o ingresa tu ID de Licencia en <a href="https://boltech-group.vercel.app" style="color: #2563eb; text-decoration: none;">boltech-group.vercel.app</a>.</li>
