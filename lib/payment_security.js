/**
 * =============================================================================
 * OPERASOVEREIGN AI — MOTOR FIDUCIARIO DE PASARELAS Y CIBERSEGURIDAD BANCARIA
...
export const CATALOGO_PRECIOS_USD = Object.freeze({
  ...
  'suite_elite_249': {
    id: 'suite_elite_249',
    name: 'Pack Suite Élite (Los 5 Agentes Integrados + Orquestador)',
    amount_usd: 249.00,
    tier: 'suite_elite'
  }
});
...
/**
 * =============================================================================
 * ⚡ PASARELA 1: STRIKE LIGHTNING NETWORK (Destino: rick2818@strike.me)
 * =============================================================================
 */
    ...
    if (this.apiKey) {
      const strikeRes = await fetch(`${this.apiBase}/invoices`, {
        ...
        body: JSON.stringify({
          ...
          description: `OperaSovereign AI - ${product.name} (Ref: ${correlationId})`,
...
/**
 * =============================================================================
 * 💳 PASARELA 2: WOMPI SV (Centroamérica & Tarjetas Bancarias)
 * =============================================================================
 */
  ...
  async createPaymentLink(productId, clientEmail, redirectUrl) {
    ...
    const response = await fetch(`${this.apiUrl}/EnlacePago`, {
      ...
      body: JSON.stringify({
        ...
        nombreProducto: `OperaSovereign AI - ${product.name}`,
        urlRedirect: redirectUrl || 'https://operasovereign.ai/success',
        configuracion: {
          esMontoEditable: false, // 🔒 Protección Bancaria: El cliente NUNCA puede modificar el monto
