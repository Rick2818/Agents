...
```mermaid
flowchart TD
    A["Agente Activo en la Nube 24/7"] --> B["Canal 1: Consola Web Cockpit\n(El dueño y gerentes le dan órdenes directas)"]
    A --> C["Canal 2: WhatsApp Business / Telegram\n(Atención a clientes y alertas al teléfono)"]
    A --> D["Canal 3: Notificaciones por Correo\n(Resúmenes diarios y reportes ejecutivos)"]
```
