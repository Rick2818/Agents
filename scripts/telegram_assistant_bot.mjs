...
• <b>Google Drive / Sheets:</b> 🟢 <i>Activo (Sincronización de balances)</i>
    ...
    // Fallback ejecutivo
    await this.sendMessage(chatId, `🎩 He recibido tu instrucción: <i>"${text}"</i>.\n\nPuedes consultar en cualquier momento: <b>/btc</b> (Bitcoin), <b>/vuelos</b> (Vuelos desde SAL), <b>/restaurantes</b> (San Salvador), <b>/cine</b> o <b>/proyectos</b>.`);
  }
