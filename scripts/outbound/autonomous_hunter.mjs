      ...
      const req = https.request({
        ...
        const auditReport = {
          ...
          monetization: {
            ...
            checkoutDirectApp: `https://destraba-ai.vercel.app/?${isEnglish ? 'lang=en&' : ''}plan=flash&domain=${domain}`,
