      ...
      const req = https.request({
        ...
        const auditReport = {
          ...
          monetization: {
            ...
            checkoutDirectApp: `https://destraba-ai.vercel.app/briefing.html?${isEnglish ? 'lang=en&' : ''}domain=${domain}`,
